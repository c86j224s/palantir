...
test('ResourceDetail blocks invalid YAML and calls toast.error', async () => {
  ...
  const { container } = render(
    <ResourceDetail resource={mockResource} namespace="default" width={768} onClose={vi.fn()} onUpdated={vi.fn()} onDeleted={vi.fn()} onDeleteStart={vi.fn()} onOpenTerminal={vi.fn()} />
  );
